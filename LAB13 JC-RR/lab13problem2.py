#CST 205 Lab 13 Problem 2 : John Coffelt, Raul Ramirez
...
def printIntro():
  ...
  """While in each room, you will be told which direction you can move.\n""" 
  """You can move in that direction by typing North, East, West or South.\n""" 
  """Type help to return to these instruction anytime.\n""" 
  """Type exit to quit the game.\n""")

#game starts here
#wait one second
printIntro()
player = requestString("Please enter your name:")#problem 2 ask for user's name

#Main while loop.
while end == false:
  printNow(RoomsArray[PlayerRoom][0]) #RoomsArray[PlayerArray[0]][0] is the title of the room
  showInformation(RoomsArray[PlayerRoom][1]) #lab 2 pops up a dialog box
...
#end while loop check for conditions and display player lose, win or quit 
if win:
  ...
  "mostly naked man saying he lived there before. You threaten him with the knife and he claims squatter's rights. Little did he know you are a lawyer. Good Job, "+player+"!+\n You Win!")
if lose:
  ...
  "He pins you down and calls the police. You are arrested and sent to jail. So sorry, "+player+".\nYOU LOSE!")
elif win == false and lose == false:
  printNow("It's a shame, "+player+". No one likes a quitter.")